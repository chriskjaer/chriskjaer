...
watch_files="$root/index.smol $root/life.smol $root/styles.smol $root/logo.smol $root/wasm/life.zig $root/wasm/life.wasm $root/scripts/smol.awk $root/scripts/wasm.sh"
