...
files="$root/public/index.html $root/public/books/index.html $root/public/pax/index.html $root/public/finance/privacy/index.html $root/public/finance/terms/index.html $root/public/projects/smol/index.html $root/public/projects/snake/index.html"
...
BEGIN { in_code = 0 }
{
  ...
  if (in_code) {
    # Keep outer-template indentation out of code blocks.
