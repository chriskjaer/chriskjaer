...
- Game of Life is written in `src/wasm/life.wasmol`. Extend its deliberately small AWK compiler only when the source needs another WebAssembly feature; do not replace it with another implementation language or a general WASM toolchain.
